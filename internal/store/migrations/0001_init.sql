...
CREATE TABLE settings (
    ...
    allowance_cap          INTEGER NOT NULL,
    allowance_rate         INTEGER NOT NULL,
    fx_house               TEXT NOT NULL CHECK (fx_house IN ('Blue', 'Official', 'MEP')),
    opening_period         TEXT NOT NULL,
    opening_leftover_pesos INTEGER NOT NULL DEFAULT 0,
    opening_cash_usd       INTEGER NOT NULL DEFAULT 0,
    opening_invested_usd   INTEGER NOT NULL DEFAULT 0
);
